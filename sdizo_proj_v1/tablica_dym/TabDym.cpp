...
TabDym::TabDym() : size_tab(0),tab(nullptr){}

void TabDym::add_head(int number) {
...
void TabDym::add_tail(int number) {
...
void TabDym::add_bottom(int index, int number) {
...
int TabDym::get_size() const {
    return size_tab;
}

void TabDym::add_if_zero(int number) {
...
void TabDym::remove_if_one_or_zero() {
...
void TabDym::swap(int num1, int num2, int index1, int index2) {
